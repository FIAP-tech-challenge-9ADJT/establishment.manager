...
public class UserApplicationService {
    ...
    public User createUser(String name, String email, String login, String password, Address address) {
        return createUserUseCase.execute(name, email, login, password, address);
    }
