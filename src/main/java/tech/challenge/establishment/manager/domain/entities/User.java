...
public class User {
    ...
    public User(UserId id, Name name, Email email, Login login, Password password, 
                Address address, Set<Role> roles, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
    ...
    public static User create(String name, String email, String login, String password, Address address) {
        var user = new User(
            null,
            Name.of(name),
            Email.of(email),
    ...
    public User addRole(Role role) {
        ...
        newRoles.add(role);
        return new User(this.id, this.name, this.email, this.login, 
                       this.password, this.address, newRoles, 
                       this.createdAt, LocalDateTime.now());
    }
